...
public class TicketingController {
    ...
    @Operation(summary = "회원:  이벤트 예매", description = "회원일 때 이벤트 예매")
    ...
    @Operation(summary = "비회원:  이벤트 예매", description = "비회원일 때 이벤트 예매")
    ...
    @Operation(summary = "회원:  예매 내역 조회", description = "회원일 때 이벤트 조회")
    ...
    @Operation(summary = "비회원:  예매 내역 조회", description = "비회원일 때 이벤트 조회")
